...
export const STANDARDS = [
	...
	},
	{
		slug: "salade-nicoise",
		marks: [
			{ id: 'salade-nicoise#arranged', text: "Arranged in distinct groups on the platter, each element liftable on its own: tuna in large hand-broken flakes rather than shredded to floss, nothing tossed into confetti, no ingredient buried." },
	...
	},
	{
		...
		marks: [
			{ id: 'soupe-a-loignon#spoonful', text: "A spoonful lifted from any depth of the pot shows mahogany strands throughout, with no pale or yellow ones hiding near the top." },
	...
	// ── 3. The Sauté Station & Pan Sauces ────────────────────────────
	{
		slug: "sole-meuniere",
		marks: [
			{ id: 'sole-meuniere#fillet', text: "The fillet leaves the pan whole and arrives whole: an even tan crust across the top face, no white floury patches at the thin tail end, and no pale grey paste welded to the pan behind it." },
			{ id: 'sole-meuniere#butter', text: "The butter solids in the sauce are brown specks, not black grit, and the butter itself is the colour of a hazelnut skin and no darker." },
			{ id: 'sole-meuniere#crust', text: "The crust is still audible under the sauce. Press a fork to the floured face on the plate and it gives a faint crackle, with the coating still dry-edged where the butter has not pooled. A fillet that waited on the plate while the noisette was fussed over arrives uniformly slack." },
			{ id: 'sole-meuniere#crust2', text: "The crust holds when a fork goes in, and the flesh beneath separates into opaque white sheets with no translucent seam at the thickest point." },
			{ id: 'sole-meuniere#taste', text: "Taste a corner: the crust is seasoned in itself, with no salt grains left sitting on the surface, and the lemon reads as brightness through the butter rather than as a sour edge sitting on top of it." }
		],
	...
	},
	{
		slug: "shrimp-scampi",
		marks: [
			{ id: 'shrimp-scampi#garlic', text: "The garlic is straw-pale and slack, every slice the same colour. One browned edge shows in a sauce this shallow, and tastes of it." },
			{ id: 'shrimp-scampi#sauce', text: "The sauce is opaque and clinging rather than clear: a spoon drawn through the pan leaves a track that closes slowly, no free butter rings the pan edge, and once the linguine goes in every strand is slick with nothing pooling in the bottom of the bowl." },
			{ id: 'shrimp-scampi#shrimp', text: "Every shrimp is a loose C. Tight closed rings mean they sat in the pan through the reduction instead of leaving it early." },
			{ id: 'shrimp-scampi#thickest', text: "Cut across the thickest part of the back: opaque to the centre, no grey translucent core, the flesh parting with a clean snap rather than compressing." },
			{ id: 'shrimp-scampi#taste', text: "Taste the sauce before the shrimp go back in: the wine reads cooked, with no raw-alcohol sharpness on the front of the tongue, and the lemon lands behind the garlic rather than in front of it." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'chicken-teriyaki#skin', text: "The skin is one continuous lacquered sheet, mahogany and flat against the meat, with no shrunken lifted edges and no black patches where the sugar caught." },
			{ id: 'chicken-teriyaki#glaze', text: "The glaze is thin enough to see the skin through and thick enough to hang: a drip off the spoon stretches before it falls, and no thin brown puddle spreads from under the thigh. On the tongue it is savoury and salty first with the sweetness behind, not candy." },
			{ id: 'chicken-teriyaki#skin2', text: "The skin holds its own under the knife. It parts with the meat rather than sliding off as a soft sheet, and the glaze sits on it as a film instead of soaking into a spongy layer." },
			{ id: 'chicken-teriyaki#sliced', text: "Sliced across after resting, the meat is uniformly opaque and the board takes a trace of clear juice, not a flood." },
			{ id: 'chicken-teriyaki#slick', text: "No fat slick anywhere: what sits under the chicken and around the slices is glaze, not oil, and it does not separate into a rim as the plate stands." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'garides-saganaki#colour', text: "No colour on the aromatics. Check before the tomatoes go in: the onion is translucent and slack with no gold at the edges and the garlic has not taken any colour. In the finished pan there are no brown flecks showing against the red." },
			{ id: 'garides-saganaki#sauce', text: "The sauce is reduced far enough that a spoon dragged across the pan bottom leaves a track that holds a beat, and a film of orange oil has come to the surface." },
			{ id: 'garides-saganaki#feta', text: "The feta is still in liftable chunks with slumped, glossy shoulders. Nothing has dissolved; the tomato around it is smooth and red, not pink and grainy." },
			{ id: 'garides-saganaki#shrimp', text: "The shrimp are loose C-curls, opaque through the back, tails bright. They finished under the lid, so none has tightened into a ring." },
			{ id: 'garides-saganaki#ouzo', text: "The ouzo reads as a thread of anise behind the tomato with no alcohol sting at the back of the throat. Taste the sauce with a crumb of feta on the spoon rather than without: the pan should land on the right side of salty once the cheese is in, and never before it." }
		],
	...
	// ── 4. The Braise ────────────────────────────────────────────────
	{
		...
		marks: [
			{ id: 'boeuf-bourguignon#sauce', text: "The sauce is glossy and near-black red, thick enough to coat the back of a spoon and hold a parted line, with no orange fat standing on the surface and no thin purple liquid at the pot's edge." },
			{ id: 'boeuf-bourguignon#cube', text: "A cube lifted out shows a dark browned exterior rather than pale grey, splits under the side of a fork with no sawing, and still holds its corners. Meat collapsed to threads in the pot went past the mark." },
			{ id: 'boeuf-bourguignon#open', text: "Cut one open: moist and uniform to the centre, with no dry grey ring of squeezed fibre inside a tender exterior." },
			{ id: 'boeuf-bourguignon#pearl', text: "Pearl onions are whole with their layers intact and the mushrooms are firm at the centre; bite one of each and it still tastes of itself rather than only of sauce." },
			{ id: 'boeuf-bourguignon#wine', text: "The wine reads as depth, not acid: round at the finish, no tannic scrape on the teeth. Salt lands square with the sauce at its final thickness, with no flat middle and no hard salty edge from a pot seasoned at the strength it had an hour earlier." }
		],
	...
	},
	{
		slug: "coq-au-vin",
		marks: [
			{ id: 'coq-au-vin#sauce', text: "The sauce is opaque brown-red, coats a spoon, and still shines at the table. A mounted sauce gone matte was boiled after the butter went in." },
			{ id: 'coq-au-vin#thigh', text: "Each thigh comes out of the pot in one piece with its skin still attached and stained wine-dark, not sloughing off as a grey rag. Nobody should expect crisp skin after an hour in liquid, but it should be whole and on the meat." },
			{ id: 'coq-au-vin#meat', text: "The meat gives at the fork but stays on the piece; pulled apart, it is wet through, not dry-shredding at the outer edge." },
			{ id: 'coq-au-vin#lardons', text: "Lardons still have bite and the pearl onions hold their shape. Neither has gone waterlogged and grey in an hour of wine." },
			{ id: 'coq-au-vin#boozy', text: "No boozy sting: the wine tastes cooked through, with no alcohol heat at the back of the throat and no sharpness on the front of the tongue." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'ragu-alla-bolognese#finished', text: "The finished colour is a dull brick-brown, not red. Still red at three hours means the paste was never cooked out or the pot never went long enough." },
			{ id: 'ragu-alla-bolognese#risen', text: "Fat has risen to a clear orange film across the top and stirs back in without separating again. Tilt the pan: solids and liquid move together, with no water running ahead." },
			{ id: 'ragu-alla-bolognese#grain', text: "A grain of meat crushes to nothing between finger and thumb. Springy pellets mean the simmer was a boil." },
			{ id: 'ragu-alla-bolognese#white', text: "No white flecks or curdled grain anywhere. The milk has gone invisible into the sauce, which is the hard mark to hit when the wine went in ahead of it." },
			{ id: 'ragu-alla-bolognese#tossed', text: "Tossed with tagliatelle and a splash of pasta water, the sauce clings the length of each ribbon and the bowl bottom stays clean." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'jamaican-oxtail-stew#gravy', text: "The gravy is opaque mahogany with a shine, and carries no black specks of carbon from the sugar." },
			{ id: 'jamaican-oxtail-stew#hangs', text: "It hangs off the ladle before it drops and sheets the back of a spoon; a spoon through the surface comes up with gravy, not oil, and no orange fat layer floats on top." },
			{ id: 'jamaican-oxtail-stew#taste', text: "Taste it: the caramel reads deep and faintly bittersweet under the allspice and thyme, with no acrid catch at the back of the throat, and the salt sits right at the gravy's reduced strength. An overnight cure plus soy plus three hours of reduction is how this pot goes over." },
			{ id: 'jamaican-oxtail-stew#meat', text: "Meat leaves the bone under light pressure from a spoon but arrives on the plate in pieces rather than as a pile of shreds, and the bones come out clean with marrow soft enough to draw." },
			{ id: 'jamaican-oxtail-stew#butter', text: "Butter beans are whole and unbroken, and a spinner torn in half shows cooked dough to the middle with no chalky raw flour core." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'birria-de-res-con-consome#distinct', text: "In the cup, a distinct red-orange fat cap sits on a deep russet broth. Grey fat means the chiles gave up nothing." },
			{ id: 'birria-de-res-con-consome#consom', text: "The consomé is smooth on the tongue, with no chile-skin fragments and no grit settling in the bottom of the cup." },
			{ id: 'birria-de-res-con-consome#meat', text: "The meat falls apart under a single fork with no pull, and a shred pulled open is wet through rather than dry and cottony at the core. Shredded back into the pot it goes red throughout, and that colour comes from the tossing, not from waiting for a marinade to reach the middle of a chunk." },
			{ id: 'birria-de-res-con-consome#dipped', text: "A dipped and griddled tortilla is stained edge to edge, crisp on both faces, and folds without cracking along the crease; torn open, the cheese pulls in strings." },
			{ id: 'birria-de-res-con-consome#taste', text: "Taste the consomé from a cup rather than off a spoon at the pot: it should be seasoned to be drunk on its own. Lime adds lift to it and should never be needed to rescue it." }
		],
	...
	// ── 5. Bread & Fermentation ──────────────────────────────────────
	{
		...
		marks: [
			{ id: 'rosemary-focaccia#stands', text: "Oil still stands in the craters at the pass and the top is an even deep gold; the flaky salt has survived as separate crystals that crunch, and the rosemary is toasted olive-green and still smells of rosemary when you lean over the pan, not blackened to ash." },
	...
	},
	{
		...
		marks: [
			...
			{ id: 'country-sourdough-loaf#tastes', text: "It tastes of wheat first with a clean, faint sourness behind it and the salt clearly present. A sharp vinegar bite, or no acidity at all under a bland crumb, means the retard was mistimed rather than the bake." }
		],
	...
	// ── 6. Pastry Fundamentals ───────────────────────────────────────
	{
		...
		marks: [
			...
			{ id: 'crepes#batch', text: "The batch yields at least a dozen from a 24cm pan. Eight or nine fat ones means they were poured thick, whatever they look like individually." }
		],
	...
	// ── 7. Fire & Smoke ──────────────────────────────────────────────
	{
		slug: "jerk-chicken",
		marks: [
			{ id: 'jerk-chicken#skin', text: "Skin is burnished dark mahogany with char confined to the slash edges and the raised ridges; the flats read brown, and no soft yellow fat is still sitting under the skin anywhere on the quarter." },
			{ id: 'jerk-chicken#slashes', text: "The slashes have opened and stayed open with paste visible sitting in them, and the meat lining each cut is stained the same rust-brown all the way down to the bone, with no pale ring under the surface." },
			{ id: 'jerk-chicken#thigh', text: "Thigh joint reads 75C, the drumstick twists free of the socket in one turn, and juice at the bone runs clear." },
			{ id: 'jerk-chicken#cleaver', text: "The cleaver passes through each bone in a single strike, leaving a clean flat face: no splinters driven into the meat, no piece needing a second blow." },
			{ id: 'jerk-chicken#taste', text: "Taste a piece of meat from inside a slash rather than the skin: it carries allspice and pimento smoke on its own, and nothing on the quarter tastes of scorched sugar or burnt soy." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'huli-huli-chicken#lacquer', text: "The lacquer is even and glossy over the whole piece, dark amber to mahogany, thick enough to hold a fingernail track, with no blistered black patches on the thin edges and no beads of carbon in the skin folds." },
			{ id: 'huli-huli-chicken#glaze', text: "The glaze is set and tacky rather than wet: a rested piece leaves no sauce puddle on the board after a minute, and the coating stays put when the piece is turned." },
			{ id: 'huli-huli-chicken#lift', text: "Lift the skin at the edge of a thigh: the fat beneath has rendered away and the skin lies tight on the meat, not floating on a soft white layer." },
			{ id: 'huli-huli-chicken#thigh', text: "Thigh reads 75C at the bone, juices run clear, and the meat beside the bone shows no translucent pink." },
			{ id: 'huli-huli-chicken#last', text: "The last coat has had fire time on it: no thin slick of uncooked sauce anywhere on the piece, no raw garlic or ketchup edge in the taste, and the sweetness reads caramelized rather than stirred in." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'memphis-dry-rub-ribs#rack', text: "The rack is matte and dry, brick red to mahogany; a fingertip drawn across it lifts spice dust rather than glaze, and nothing tacky transfers to the board." },
			{ id: 'memphis-dry-rub-ribs#lifted', text: "Lifted with tongs a third of the way along, the rack bends toward 90 degrees and the surface cracks open between the bones without the meat tearing free." },
			{ id: 'memphis-dry-rub-ribs#turn', text: "Turn the rack over: no papery membrane is left anywhere on the bone side, and the fat between the bones has rendered soft rather than sitting in rubbery seams." },
			{ id: 'memphis-dry-rub-ribs#bite', text: "A bite pulls meat cleanly away leaving a clean bite mark, and the bone stays in the rack; bones that slide out grey and bare are past the standard." },
			{ id: 'memphis-dry-rub-ribs#final', text: "The final dusting reads as raw spice on the lips, paprika and celery salt distinct from the cooked bark beneath, and no sauce has touched the meat." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'tacos-al-pastor-home-trompo#shaves', text: "Shaves come off in thin strips 2 to 3mm across, ragged and short, never cubes or slabs." },
			{ id: 'tacos-al-pastor-home-trompo#shaved', text: "The shaved meat is brick red from achiote through the full half-centimetre of each sheet, not stained on the outer face with pale pork underneath." },
			{ id: 'tacos-al-pastor-home-trompo#spoonful', text: "Every spoonful holds two textures: lacquered crisp edges that crackle between the fingers against a soft interior, and no piece is soft the whole way through. Uniform tenderness is a failed pass." },
			{ id: 'tacos-al-pastor-home-trompo#pineapple', text: "The pineapple wedge is charred at the edge, still holds its shape when lifted, and releases juice when bitten; it is a thin wedge on each taco, not a dice stirred through." },
			{ id: 'tacos-al-pastor-home-trompo#tortilla', text: "The tortilla is warm and pliable enough to fold twice without cracking, and a 40 to 50g portion rides in it held in one hand without soaking through or spilling out the fold." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'central-texas-smoked-brisket#bark', text: "Bark is uniform near-black mahogany and stays put: a thumb drawn across it neither smears nor lifts, and the coarse pepper is still visible as grain in the crust." },
			{ id: 'central-texas-smoked-brisket#resistance', text: "Resistance to the probe is equal at three points along the flat, thick end included, at 95C internal; one soft spot and two firm ones means it goes back on." },
			{ id: 'central-texas-smoked-brisket#rendered', text: "The fat cap has rendered translucent and spreadable, and the seam fat inside the point gives under finger pressure with no hard white core left in it." },
			{ id: 'central-texas-smoked-brisket#slices', text: "Slices are pencil-width, about 6mm, cut across the grain on the flat and again after the point is turned 90 degrees; a slice held at one end drapes over a finger, parts under a gentle tug, and does not shred under its own weight or spring back." },
			{ id: 'central-texas-smoked-brisket#slice', text: "A slice from the thin end of the flat, not the point, beads moisture immediately when squeezed between two fingers, and the board carries beads and smears rather than a spreading pool; the crust tastes of pepper first with the salt behind it, and no slice needs sauce." }
		],
	...
	// ── 8. The Wok & High Heat ───────────────────────────────────────
	{
		slug: "pad-krapow-moo",
		marks: [
			{ id: 'pad-krapow-moo#pork', text: "The pork is in separate browned crumbles with crisp edges and dark caught faces, not a uniform pale mince, and no grey liquid sits in the bottom of the wok." },
			{ id: 'pad-krapow-moo#sauce', text: "The sauce is a glaze clinging to the meat: tilt the plate and nothing runs from under the pork." },
			{ id: 'pad-krapow-moo#holy', text: "Holy basil is wilted but whole-leafed and still green, no leaf blackened or dissolved into the sauce, leaves show in every spoonful rather than as scattered flecks, and its clove-pepper smell rises off the plate." },
			{ id: 'pad-krapow-moo#fried', text: "The fried egg has brittle brown lace at the rim that shatters under a spoon, and the yolk breaks and runs when pierced." },
			{ id: 'pad-krapow-moo#fish', text: "Fish and oyster salt lead, sugar is barely traceable, and the garlic tastes toasted rather than raw or acrid." }
		],
	...
	},
	{
		slug: "bulgogi",
		marks: [
			{ id: 'bulgogi#slices', text: "The slices are 1 to 2mm, thin enough to pass light before cooking, and they lie on the plate as loose separate ribbons rather than a fused clump." },
			{ id: 'bulgogi#ribbon', text: "Each ribbon shows dark caramelized edges against a lighter centre, and the last batch is the same colour as the first: anything uniformly grey-brown never touched hot metal, and anything speckled with black flecks picked up burnt sugar left in the pan." },
			{ id: 'bulgogi#finishes', text: "The pan finishes each batch nearly dry, a spoonful of syrupy drippings and no pool of simmering marinade." },
			{ id: 'bulgogi#onion', text: "Onion and mushroom come out browned and collapsed but still holding shape, tasting of the drippings rather than of raw marinade." },
			{ id: 'bulgogi#closed', text: "A closed ssam is bitten through in one go without the meat dragging out of the leaf, the slices parting under the teeth rather than needing to be chewed apart." }
		],
	...
	},
	{
		slug: "char-kway-teow",
		marks: [
			{ id: 'char-kway-teow#noodles', text: "Noodles lift as individual strands, glossy and separate, with no torn fragments and no mat of stuck-together ribbons." },
			{ id: 'char-kway-teow#colour', text: "Colour is deliberately uneven: dark soy stains some strands more than others and scattered noodles carry black-brown char blisters. Even mahogany throughout means it was stirred rather than charred." },
			{ id: 'char-kway-teow#held', text: "Held at arm's length the plate smells of scorch and smoke before it smells of soy, and that smell is still on it when it reaches the table." },
			{ id: 'char-kway-teow#ragged', text: "Egg is in ragged folds gripping the noodles, set but soft, with no separate scrambled lumps and no wet gloss of raw white." },
			{ id: 'char-kway-teow#bean', text: "Bean sprouts snap between the teeth, the chives are bright green, the shrimp are curled once and just opaque, and the plate rim carries no pooled oil or sauce." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'rau-muong-xao-toi#leaves', text: "Leaves are dark and glossy green with none gone olive or grey, and the split stems have kept their pale jade colour." },
			{ id: 'rau-muong-xao-toi#stems', text: "Stems snap under the tooth and the leaves are tender in the same mouthful: no raw crunch at the thick ends, no collapse in the leaves." },
			{ id: 'rau-muong-xao-toi#bowl', text: "The bowl is nearly dry, under a tablespoon of liquid after standing a minute, and the greens are coated in oil rather than sitting in a puddle." },
			{ id: 'rau-muong-xao-toi#smashed', text: "The smashed cloves have gone gold and soft through, sweet rather than raw-sharp, with none scorched black or bitter, and one turns up in most mouthfuls." },
			{ id: 'rau-muong-xao-toi#fish-sauce', text: "No raw fish-sauce smell comes off the bowl: it reads as savoury salt rather than as fish, and no sweetness is identifiable as sugar." }
		],
	...
	},
	{
		...
		marks: [
			{ id: 'miso-glazed-black-cod#lacquered', text: "Lacquered mahogany across the surface with genuine black at the corners and the raised edges; a flat even gold means it never sat close enough to the element, or the cure was too short to give the sugars anything to work with." },
	...
	},
	{
		...
		marks: [
			{ id: 'calamari-fritti#reads', text: "The oil reads a true 190°C as the squid goes in and climbs back to it before the next batch; a batch that drags it below about 170°C is already lost and no amount of extra time will recover it." },
	...
	},
	{
		slug: "baked-alaska",
		marks: [
			{ id: 'baked-alaska#no-go', text: "The go/no-go at the oven door: the meringue held a straight peak off the whisk and the bowl was cool to the palm before any of it went on, and the assembled dome is hard to a knuckle-rap everywhere, base included. A dome that gives anywhere goes back to the freezer, not into the oven." },
			{ id: 'baked-alaska#sealed', text: "Sealed all round: at least 2cm of meringue over the dome, covering the cake edge and meeting the tray, with no window of ice cream showing and no crack at the base." },
			{ id: 'baked-alaska#peaks', text: "Peaks bronzed with the valleys still cream-white after 3 to 4 minutes; an evenly tanned dome means it stayed in and the heat reached the ice cream." },
